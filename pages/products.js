...
export default function Index() {
  return (
    <Layout>
      <Metadata title={"Products"} image="/img/screenshot.jpg" />
        ...
        <Container className="left relative z-10">
          <div className="lg:w-1/2">
            ...
            <p>
              ...
              manage utilization, distribute whitelist access, and bulk airdrop
              tokens. Simplified control and powerful utility with just a few
              clicks.
            </p>
