			...
			<div className="bg-white">
				...
				<Section className="-mt-24 lg:-mt-48 hidden lg:block">
					<div className='w-full max-w-lg mx-auto drop-shadow-lg'>
						<Image src='/uploads/marketplace-1.png' width={2248 / 2} height={1451 / 2} />
						<div className="absolute top-1/4 -left-1/4 w-1/3 drop-shadow-lg">
							<Image src='/uploads/marketplace-3.png' width={453 / 2} height={410 / 2} />
						</div>
						<div className="absolute top-8 -right-1/4 w-5/12 drop-shadow-lg">
							<Image src='/uploads/marketplace-2.png' width={698 / 2} height={501 / 2} />
						</div>
					</div>
				</Section>
