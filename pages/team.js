...
function TeamMember(props) {
  ...
  return (
    <div className="w-11/12 lg:w-5/12 max-w-sm border border-[#fafafa] p-2 shadow-xl rounded-xl">
      <div
        className="rounded-xl aspect-[1/1.1] w-full relative overflow-hidden"
        style={{
        ...
        <div className="flex flex-col lg:flex-row lg:my-12 my-6 justify-center relative z-50">
          <div className="lg:w-1/2 w-full px-8 max-w-xl">
            ...
            <p>
              ...
              our years of experience building in the crypto / web3 ecosystem
              and delivering success at top global brands. For brands, web3
              represents a massive opportunity where exponential growth is
              possible, yet there exist unique challenges that must be
              considered. When you work with Holaplex you get a partner.
            </p>
          </div>
          <div className="flex flex-col lg:flex-row flex-wrap w-full max-w-4xl relative overflow-hidden lg:p-8 rounded-xl justify-around items-center lg:items-stretch gap-4">
            ...
            <TeamMember
              name="Alex Kehaya"
              role="CEO"
              image="/img/team/Alex-Kehaya.png"
              color="#6CCDD6"
            />
            <TeamMember
              name="Anja Bedford"
              role="COO"
              image="/img/team/Anja-Bedford.png"
              color="#A4E8DB"
            />
            <TeamMember
              name="Matthew Stotts"
              role="CSO"
              image="/img/team/Matthew-Stotts.png"
              color="#C7F5F9"
            />
            <TeamMember
              name="Brian Fox"
              role="CTO"
              image="/img/team/BrianFoxPFP3.png"
              objectFit="cover"
              color="#C7F5F9"
            />
          </div>
