    ...
    <Layout>
      ...
      <Section className="text-black bg-white">
        <Container className="text-center">
          <div className="flex flex-wrap justify-center items-center w-full -mt-8 mb-8 gap-4 lg:gap-16">
            ...
            <div className="w-16 lg:w-24">
              <a href="https://campus.io/" target="_blank" rel="noreferrer">
                <img
                  alt="Campus Legends"
                  src="/img/logos/campus.png"
                  width={304}
                  height={80}
                />
              </a>
            ...
            <div className="w-16 lg:w-24">
              <a href="https://nation.io/" target="_blank" rel="noreferrer">
                <img
                  alt="Nation"
                  src="/img/logos/nation.png"
                  width={203}
                  height={80}
                />
              </a>
          ...
          <div className="w-16 lg:w-24 mx-auto mt-8 lg:mt-16">
            <a href="https://opensea.io/" target="_blank" rel="noreferrer">
              <img
                alt="OpenSea"
                src="/img/logos/opensea.png"
          ...
          <p className="mb-4 relative">
            <img
              className="absolute top-0 right-[100%] lg:w-6 w-4"
              alt=""
              width={32}
              height={32}
              src="/img/icons/quote-left.svg"
            />
            <span>
              We are able to quickly and effectively build Solana NFTs drops for
              our launchpad program with Holaplex’s minting tools.
            </span>
            <img
              className="absolute top-0 left-[100%] lg:w-6 w-4"
              alt=""
              width={32}
              height={32}
        ...
        <Container>
          <div className="flex flex-wrap justify-around items-center text-center lg:text-left">
            <div className="my-2">
              <h2 className="m-0">
                <GradientText className="mt-0 inline lg:w-1/4 font-medium">
                  10,000
                </GradientText>
              </h2>
            ...
            <div className="my-2">
              ...
              <p className="mt-0 font-bold">
                Billions of data points accessible in milliseconds
              </p>
            </div>
            <div className="hidden lg:block h-16 border-r" />
            <div className="my-2">
      ...
      >
        ...
        <Container className="text-center relative z-10">
          ...
          <p>
            Onboard to web3 with ease. Built with our suite of open-source
            software tools and contributions from leading integration partners.
          </p>
        </Container>
        <Container variant="wide">
          <div className="gap-4 flex flex-wrap justify-center">
            ...
            <SubtleGlassTile className="blue-section">
              <img
                src="/img/icons/utility-management.svg"
                width="50"
                height="50"
                alt=""
              />
        ...
        <Section className="relative my-6 lg:my-12 py-6 lg:py-12">
          ...
          <Container className="left relative z-10">
            <div className="lg:w-1/2">
              ...
              <h3 className="lg:mt-2 mt-0">
                <GradientText>Easily Create And Manage NFTs</GradientText>
              </h3>
              <p>
                Enterprise grade NFT backend enables you to easily create and
                manage all of your brands NFT assets. Create NFT drops at scale,
                manage utilization, distribute whitelist access, and bulk
                airdrop tokens. Simplified control and powerful utility with
                just a few clicks.
              </p>
        ...
        <Section className="relative my-6 lg:my-12 py-6 lg:py-12">
          ...
          <Container className="left relative z-10">
            <div className="lg:w-1/2 lg:ml-auto">
              ...
              <h3 className="lg:mt-2 mt-0">
                <GradientText>FEATURE COMPLETE MARKETPLACES</GradientText>
              </h3>
              <p>
                Quickly launch a whitelabel NFT marketplace or build a bespoke
                experience with our fully customized solution. With new
                integrations every month, from a community of integration
                partners, your marketplace will always have the latest and
                greatest that web3 has to offer.
              </p>
      ...
      <Section className="bg-brandPurple text-white relative overflow-hidden text-center">
        ...
        <div
          className="absolute w-64 aspect-square z-20 bottom-1/2 left-1/4"
          style={{
        ...
        <Container className="relative z-50">
          <div
            className="bg-[#140F35] w-full p-2 lg:p-8 border rounded-lg"
            style={{ borderColor: "rgba(255,255,255,0.45)" }}
          >
            <h2 className=" mt-0">
              <GradientText className="gray">
                POWERFUL APIS FOR WEB3 APPS
              </GradientText>
            </h2>
            <p className="opacity-60">
              We make your web3 applications run at hyperspeeds. Reading data
              directly from the blockchain can cause long load times. With our
              indexer API, we deliver low latency read performance even when TPS
              is low.
            </p>
            <div className="my-8 hidden lg:block">
              <Image
                src="/img/cool-chart-2.svg"
                alt=""
                width={1128}
                height={150}
              />
        ...
        <Container className="relative z-50">
          <h2>
            <GradientText className="gray">
              Providing Rapid Innovation
            </GradientText>
          </h2>
          <p className="opacity-60">
            Open-source development provides strategic advantages through faster
            product development, improved security and flexibility with no
            licensing fees. Web3 is a rapidly growing space and building openly
            ensures the technology stack is always up to date. Holaplex is a
            leading open source Web3 contributor.
          </p>
