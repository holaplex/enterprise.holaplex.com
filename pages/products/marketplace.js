  ...
  return (
    <Layout>
      <div className="bg-white">
        ...
        >
          <h1 className="mt-0">
            Launch your brand&apos;s, custom NFT Marketplace
          </h1>
          <p>
            Leverage the power of Web3 by giving your customers an
            industry-leading user experience with Holaplex’s whitelabel
            marketplace.
          </p>
        </SectionHero>
        ...
        <Section className="bg-gray-50 text-black lg:text-center lg:mt-10 py-4">
          <Container variant="small">
            ...
            <h2>
              <GradientText>Get the best that web3 has to offer</GradientText>
            </h2>
            <p>
        ...
        <ProductSection
          ...
          image={
            <Image
              src="/uploads/marketplace-sell.jpg"
              width={1200}
              height={774}
            />
          }
        >
          ...
          <h3>
            <GradientText>Sell NFTs at scale</GradientText>
          </h3>
          <p>
            Drive primary sales with your optimized NFT commerce site. Zero NFT
            knowledge is required for customers to buy, sell and own NFTs. We
            make it easy to create world-class web3 experiences.
          </p>
        </ProductSection>
        ...
        <ProductSection
          image={
            <Image
              src="/uploads/marketplace-hub.jpg"
              width={1200}
              height={776}
            />
          }
        >
          ...
          <h3>
            <GradientText>The NFT trading hub for your brand</GradientText>
          </h3>
          <p>
            Capture your maximum potential with a secondary marketplace. Own
            your customer&apos;s journey through the entire NFT experience,
            support customer-to-customer interactions, and unlock opportunities
        ...
        <ProductSection
          ...
          image={
            <Image
              src="/uploads/marketplace-onboard.jpg"
              width={1200}
              height={775}
            />
          }
        >
          ...
          <h3>
            <GradientText>Easily onboard your customers into web3</GradientText>
          </h3>
          <p>
            Offer safe, reliable, and low-friction wallet management for your
            users. Allow your customers to use their existing wallets or manage
            their wallet for them while they maintain control over their assets.
            Stay compliant and deliver an easy onboarding experience.
          </p>
        </ProductSection>
          ...
          features={[
            {
              icon: (
                ...
                >
                  <path
                    d="M30.3334 48.9949H25.6668V15.9316L21.9568 19.6183L18.6668 16.3283L28.0001 6.99493L37.3334 16.3283L34.0434 19.6183L30.3334 15.9316V20.9949C30.3334 30.9583 39.7368 37.6316 44.3334 40.2916L40.9268 43.6983C36.4701 40.9916 32.9001 37.7949 30.3334 34.3183V48.9949Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M9.33329 14H4.66663V46.6667C4.66663 49.2333 6.76663 51.3333 9.33329 51.3333H42V46.6667H9.33329V14Z"
                    fill="#528AD5"
                  />
                  <path
                    d="M46.6667 4.66669H18.6667C16.1 4.66669 14 6.76669 14 9.33335V37.3334C14 39.9 16.1 42 18.6667 42H46.6667C49.2333 42 51.3333 39.9 51.3333 37.3334V9.33335C51.3333 6.76669 49.2333 4.66669 46.6667 4.66669ZM46.6667 28L40.8333 24.5L35 28V9.33335H46.6667V28Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M7 7H25.6667V25.6667H7V7ZM30.3333 7H49V25.6667H30.3333V7ZM7 30.3333H25.6667V49H7V30.3333ZM42 30.3333H37.3333V37.3333H30.3333V42H37.3333V49H42V42H49V37.3333H42V30.3333Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M28 18.6667C22.8433 18.6667 18.6667 22.8433 18.6667 28C18.6667 33.1567 22.8433 37.3333 28 37.3333C33.1567 37.3333 37.3333 33.1567 37.3333 28C37.3333 22.8433 33.1567 18.6667 28 18.6667ZM11.6667 35H7V44.3333C7 46.9 9.1 49 11.6667 49H21V44.3333H11.6667V35ZM11.6667 11.6667H21V7H11.6667C9.1 7 7 9.1 7 11.6667V21H11.6667V11.6667ZM44.3333 7H35V11.6667H44.3333V21H49V11.6667C49 9.1 46.9 7 44.3333 7ZM44.3333 44.3333H35V49H44.3333C46.9 49 49 46.9 49 44.3333V35H44.3333V44.3333Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
