  ...
  return (
    <Layout>
      <div className="bg-white">
        ...
        <SectionHero
          slanted="h-24 lg:h-96 hidden lg:block"
          slantedColor="#ffffff"
        >
          <h1 className="mt-0">Minting and NFT management made simple</h1>
          <p>
            Create thousands of NFTs, manage utilities, and get detailed
        ...
        <Section className="-mt-24 lg:-mt-96 hidden lg:block">
          <div className="w-7/12 max-w-3xl mx-auto drop-shadow-lg">
            <Image
              src="/uploads/command-center-1.jpg"
            ...
            <div className="absolute top-1/4 -left-1/4 w-1/3 drop-shadow-lg">
              <Image
                src="/uploads/command-center-2.jpg"
                width={510}
                height={498}
                priority
            ...
            <div className="absolute top-8 -right-1/4 w-1/3 drop-shadow-lg">
              <Image
                src="/uploads/command-center-3.jpg"
                width={700}
                height={686}
                priority
                className="rounded-xl"
        ...
        <Section className="bg-brandPurple text-white lg:text-center lg:mt-10 py-4">
          <Container variant="small">
            <h4>
              Holaplex <span className="font-thin">Marketplaces</span>
            </h4>
            <h2>
              <GradientText className="silver-transparent inline-block">
                Get the best that web3 has to offer
              </GradientText>
            </h2>
            <p>
              Feature-complete marketplaces with advanced features from top
        ...
        <ProductSection
          image={
            <Image
              src="/uploads/create-drop-mock-1.jpg"
              width={1316}
              height={852}
            />
          }
        >
          ...
          <h3>
            <GradientText>Create NFTs At Scale</GradientText>
          </h3>
          <p>
            Need to mint tens, hundreds, thousands, or maybe millions of NFTs?
            No problem! Minting with Holaplex saves you time and money by
            simplifying the minting process. We handle the technology so you can
            focus on selling.
          </p>
        </ProductSection>
        ...
        <ProductSection
          image={
            <Image
              src="/uploads/marketplace-customer-facing-2.jpg"
              width={1316}
              height={854}
            />
          }
        ...
        >
          ...
          <h3>
            <GradientText>Edit and Manage Your NFTs</GradientText>
          </h3>
          <p>
            Control your created NFTs to drive powerful utilities. With a
            central user interface, you can grant NFT holders access to gated
            content, enable redeemable rewards, or edit metadata.
          </p>
        </ProductSection>
        ...
        <ProductSection
          ...
          image={
            <Image
              src="/uploads/Group-1000000828.jpg"
              width={1271}
              height={1052}
            />
          }
        >
          ...
          <h3>
            <GradientText>Send NFTs to Your Customers</GradientText>
          </h3>
          <p>
            Create compelling campaigns that drive engagement by sending NFTs to
            specific groups of users. With just a few clicks you can you can
            create exciting experiences and that increase action.
          </p>
        </ProductSection>
        ...
        <ProductSection
          image={
            <Image
              src="/uploads/marketplace-home-page-customer-facing.jpg"
              width={1316}
              height={850}
            />
          }
        ...
        >
          ...
          <p>
            Actionable insights at your fingertips. No blockchain wizardry
            needed, just clear, visual, and intuitive dashboards to stay on
            track and so you can reach your goals. Access decoded blockchain
          ...
          features={[
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M28 2.33337L7 11.6667V25.6667C7 38.6167 15.96 50.7267 28 53.6667C40.04 50.7267 49 38.6167 49 25.6667V11.6667L28 2.33337ZM28 27.9767H44.3333C43.0967 37.59 36.68 46.1534 28 48.8367V28H11.6667V14.7L28 7.44337V27.9767Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M44.4033 8.30662C40.5066 5.06328 35.6766 2.93995 30.3333 2.44995V7.13995C34.3699 7.58328 38.0566 9.19328 41.09 11.62L44.4033 8.30662ZM25.6666 7.13995V2.44995C20.3233 2.91662 15.4933 5.06328 11.5966 8.30662L14.91 11.62C17.9964 9.13382 21.7279 7.57968 25.6666 7.13995ZM11.62 14.91L8.30662 11.5966C5.06328 15.4933 2.93995 20.3233 2.44995 25.6666H7.13995C7.58328 21.6299 9.19328 17.9433 11.62 14.91ZM48.86 25.6666H53.55C53.06 20.3233 50.9366 15.4933 47.6933 11.5966L44.38 14.91C46.8661 17.9964 48.4202 21.7279 48.86 25.6666ZM16.3333 28L24.3599 31.6399L28 39.6666L31.6399 31.6399L39.6666 28L31.6399 24.3599L28 16.3333L24.3599 24.3599L16.3333 28Z"
                    fill="#528AD5"
                  />
                  <path
                    d="M27.9999 49C24.5541 48.9993 21.1618 48.1468 18.1249 46.5185C15.0881 44.8901 12.5008 42.5364 10.5933 39.6667H16.3333V35H2.33325V49H6.99992V42.7C11.6433 49.3267 19.2966 53.6667 27.9999 53.6667C39.3633 53.6667 48.9999 46.27 52.3599 36.0267L47.7866 34.9767C44.9166 43.12 37.1466 49 27.9999 49Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M12.2501 18.8276L18.8534 12.2313L51.8327 45.2479L45.2294 51.8443L12.2501 18.8276ZM22.1341 8.92961L28.7327 2.32861L41.9324 15.5259L35.3337 22.1293L22.1341 8.92961ZM2.33105 28.7349L8.92972 22.1339L22.1294 35.3336L15.5307 41.9323L2.33105 28.7349ZM2.33339 48.9999H30.3334V53.6666H2.33339V48.9999Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
            ...
            },
            {
              icon: (
                ...
                >
                  <path
                    d="M27.5332 25.4333C22.2366 24.0567 20.5332 22.6333 20.5332 20.4167C20.5332 17.8733 22.8899 16.1 26.8332 16.1C30.9866 16.1 32.5266 18.0833 32.6666 21H37.8232C37.6599 16.9867 35.2099 13.3 30.3332 12.11V7H23.3332V12.04C18.8066 13.02 15.1666 15.96 15.1666 20.4633C15.1666 25.8533 19.6232 28.5367 26.1332 30.1C31.9666 31.5 33.1332 33.5533 33.1332 35.7233C33.1332 37.3333 31.9899 39.9 26.8332 39.9C22.0266 39.9 20.1366 37.7533 19.8799 35H14.7466C15.0266 40.11 18.8532 42.98 23.3332 43.9367V49H30.3332V43.9833C34.8832 43.12 38.4999 40.4833 38.4999 35.7C38.4999 29.0733 32.8299 26.81 27.5332 25.4333Z"
                    fill="#528AD5"
                  />
                </svg>
              ),
