...
export default function SectionHero(props) {
  return (
    <Section
      className="text-white text-center relative -mt-24 pt-24 pb-12 bg-[#030E37] overflow-hidden"
      css={css`
    ...
    >
      ...
      <Container
        variant="wide"
        className="flex flex-col lg:my-12 justify-center items-center relative z-50"
      >
        {props.children}
      </Container>

      {props.hasOwnProperty("slanted") ? (
        <div className={"-mb-12 relative overflow-hidden " + props.slanted}>
          <svg
