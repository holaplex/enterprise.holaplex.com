      ...
      <nav className="max-w-7xl mx-auto w-full px-2 py-8 gap-4 box-border flex flex-col lg:flex-row justify-between items-center lg:items-start text-center lg:text-left">
        ...
        <div className="lg:w-1/2">
          <ul className="lg:flex justify-around flex-wrap gap-4 w-full">
            <li>
              <SmartLink href="https://docs.google.com/document/d/1jskpoCdDm7DU2IbeXwRhhl5LGiNhonAx2HsmfJlDsEs/edit">
                Terms of Service
              </SmartLink>
            </li>
            <li>
              <SmartLink href="https://docs.google.com/document/d/12uQU7LbLUd0bY7Nz13-F9cua5Wk8mnRNBlyDzF6gRmo/edit">
                Privacy Policy
              </SmartLink>
            </li>
            <li>
              <SmartLink href="https://blog.holaplex.com">Blog</SmartLink>
            </li>
          </ul>
        </div>
      </nav>
